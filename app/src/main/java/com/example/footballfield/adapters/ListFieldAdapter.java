package com.example.footballfield.adapters;
...
public class ListFieldAdapter implements ListAdapter {
    ArrayList<SubjectData> arrayList;
    Context context;
    public ListFieldAdapter(Context context, ArrayList<SubjectData> arrayList) {
